...
const UpdateProduct = ({match}) => {
    ...
    const clickSubmit = (event) => {
        ...
        .then(data => {
            if(data.error) {
                ...
                setValues({...values, name: '', description: '', photo: '', price: '', quantity: '', height: '', length: '', error: false, redirectToProfile: true, loading: false, createdProduct: data.name,});
            }
        })
    }
    ...
    return (
        <Layout title="Add a New Product" description={`Hello, ${user.name}! Please use the form below to update an existing product.`} className="container-fluid">
            <div className="row">
